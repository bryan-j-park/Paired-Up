        ...
        axios.get('http://localhost:8000/api/shoes')
            .then(res => {
                ...
                if (colors[0].options[index].value === e.target.value) {
                    ...
                    categories[0].options[index].checked = !categories[0].options[index].checked;
                }

                let filterByColor = colorFilter(shoes);
                let filterByCat = categoryFilter(filterByColor);

                filterByCat.length < 1 ? setAllShoes(shoes) : setAllShoes(filterByCat);
                            ...
                            <Menu as="div" className="relative inline-block text-left">
                                ...
                                >
                                    <Menu.Items className="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none">
                                        <div className="py-1">
                                            <Menu.Item>
                                                <p onClick={() => handleName(allShoes)} className='block px-4 py-2 text-sm cursor-pointer hover:bg-light-blue hover:text-white'>Alphabetically A-Z</p>
                                            </Menu.Item>
                                            <Menu.Item id='low'>
                                                <p onClick={(e) => handlePrice(e, allShoes)} id='low' className='block px-4 py-2 text-sm cursor-pointer hover:bg-light-blue hover:text-white'>Price: Low to High</p>
                                            </Menu.Item>
                                            <Menu.Item id='high'>
                                                <p onClick={(e) => handlePrice(e, allShoes)} id='high' className='block px-4 py-2 text-sm cursor-pointer hover:bg-light-blue hover:text-white'>Price: High to Low</p>
                                            </Menu.Item>
                                        </div>
                                    </Menu.Items>
                                </Transition>
